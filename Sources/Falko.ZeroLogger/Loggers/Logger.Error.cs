...
public readonly partial struct Logger
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Error<T>(T messageState, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Error<T>(Exception? exception, T messageState, LogMessageFactory<T> messageFactory)
    {
        var loggerContext = _loggerRuntime.LoggerContext;
